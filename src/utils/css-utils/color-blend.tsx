...
export function linearColorBlend(start: string | number[], end: string | number[], time: number): number[] {
...
export function projectAlphaOnOpaque(alphaColor: string | number[], opaqueColor: string | number[]){
    let color1 = Array.isArray(alphaColor) ? [...alphaColor] : parseRgb(alphaColor);
    let color2 = Array.isArray(opaqueColor) ? [...opaqueColor] : parseRgb(opaqueColor);
